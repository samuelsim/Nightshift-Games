...
const quickTips: Record<string,string> = {
 'estimate':'Estimate the amount in 30 seconds. Closer guesses score more. Round count is set in the lobby.',
 'pick-number':'Pick 1–10. Closest to the hidden target wins. Round count is set in the lobby.',
 'pick-number-solo':'Find the hidden number in 20 seconds. You get 3 guesses and higher/lower hints.',
 'human-exe':'Check your secret role. Pick the most human or machine-like answer. Round count is set in the lobby.',
